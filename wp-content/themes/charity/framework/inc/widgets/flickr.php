...
<div class="sd-flickr"> 
	<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=<?php echo $instance['how_many']; ?>&amp;display=<?php echo $instance['display']; ?>&amp;size=s&amp;layout=x&amp;source=<?php echo $instance['type']; ?>&amp;<?php echo $instance['type']; ?>=<?php echo $instance['flickrID']; ?>"></script> 
</div>
<?php 
		// After the widget
		echo $after_widget;
